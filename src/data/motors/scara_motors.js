export const scara_position_information = [
    //{id: 0, text:"Botón de guardado", min: 0, max: 2, default:0},
    //{id: 1, text:"Botón de ejecutar valores aceptables", min: -90, max: 90, default:0},
    {id: 2, text:"Revoluta 1", min: -90, max: 90, default:-90},
